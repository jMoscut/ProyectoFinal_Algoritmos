...
public class FrmTask extends javax.swing.JFrame {
    ...
    public FrmTask() throws ParseException {
        initComponents();
        setLocationRelativeTo(this);
        listarComentarios();
        tarea = GlobalStatus.TransferenciaTarea;
    ...
    public void listarComentarios(){
        ...
        lista = GlobalStatus.TransferenciaTarea.leerComentariosTarea();
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Telugu Sangam MN", 1, 14)); // NOI18N
        jLabel1.setText("Lista de Tareas a la que pertenece:");

        jLabel2.setFont(new java.awt.Font("Telugu Sangam MN", 1, 14)); // NOI18N
        jLabel2.setText("Nombre de esta tarea: ");

        jLabel3.setFont(new java.awt.Font("Telugu Sangam MN", 1, 14)); // NOI18N
        jLabel3.setText("Decripcion general de la tarea: ");

        jLabel4.setFont(new java.awt.Font("Telugu Sangam MN", 1, 14)); // NOI18N
        jLabel4.setText("Vencimiento de la tarea: ");

        jLabel5.setFont(new java.awt.Font("Telugu Sangam MN", 1, 14)); // NOI18N
        ...
        DescripcionTarea.setFont(new java.awt.Font("Menlo", 3, 14)); // NOI18N
        ...
        VencimientoTarea.setFont(new java.awt.Font("Menlo", 3, 14)); // NOI18N
        ...
        EstadoTarea.setFont(new java.awt.Font("Menlo", 3, 14)); // NOI18N
        ...
        ListadoTarea.setFont(new java.awt.Font("Menlo", 3, 14)); // NOI18N
        ...
        NombreTarea.setFont(new java.awt.Font("Menlo", 3, 14)); // NOI18N
        ...
        jButton3.setFont(new java.awt.Font("STSong", 1, 18)); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MainOrganizer/Pictures/ADD.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FrmTask.class.getName()).log(Level.SEVERE, null, ex);
        }
          frm.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        FrmModifyTask frm = new FrmModifyTask();
        frm.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
            FrmAddListActivity frm = new FrmAddListActivity();
            frm.setVisible(true);
            this.setVisible(false);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        GlobalStatus.TransferencialistadoTareas.eliminarTarea(id);
        ListedTasks frm = new ListedTasks();
        frm.setVisible(true);
        this.setVisible(false);
    ...
    private void tblComentariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblComentariosMouseClicked
        ...
        Comments Transferencia = GlobalStatus.TransferenciaComentarios;
